  ...
  const handleSubmit = useCallback(async (data: ResetPasswordFormData) => {
    try {
      ...
      const schema = Yup.object().shape({
        ...
        password_confirmation: Yup.string().oneOf([Yup.ref('password'), undefined], 'Confirmacao incorreta'),
      });
      ...
      <Content>
        <AnimationContainer>
          ...
          <Form ref={formRef} onSubmit={handleSubmit}>
            ...
            <Input name="password_confirmation" icon={FiLock} type="password" placeholder="Confirmacao de Senha"></Input>
